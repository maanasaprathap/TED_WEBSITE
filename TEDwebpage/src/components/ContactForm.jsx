...
const ContactSection = () => {
  const handleSubmit = (e) => {
    ...
    alert(`Thank you for contacting us ${fname}. Our team will get back to you soon.😊`);
  };
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            ...
            <div class="p-4 py-6 rounded-lg  md:p-8">
                <form>
                    ...
                    <div class="mt-4">
                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">Phone No.</label>
                        <input type="tel" placeholder="+91XXXXXXXX" class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
